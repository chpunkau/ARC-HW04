...
documentary_output: db "Puzzle: text = %s, number = %d, answer = %d", 10, 0
cartoon_output: db "Proverb: text = %s, number = %d, country = %s", 10, 0
fiction_output: db "Aphorism: text = %s, number = %d, author = %s", 10, 0
draw_lowercase: db "france", 0
puppet_lowercase: db "usa", 0
plasticine_lowercase: db "russia", 0
draw_uppercase: db "FRANCE", 0
puppet_uppercase: db "USA", 0
plasticine_uppercase: db "RUSSIA", 0
number_format: db "%d", 0
number_format_with_colon: db "%d: ", 0
incorrect_movie: db "Incorrect text!", 10, 0
...
incorrect_files_string: db "passed files not found", 10, 0
start: db "Start", 0
stop: db "Stop", 0
